...
![文件包含in_put地址栏](E:\cyber safe\笔记\笔记\笔记图片\文件包含in_put地址栏.JPG)
...
![文件包含intput的抓包更改](E:\cyber safe\笔记\笔记\笔记图片\文件包含intput的抓包更改.JPG)
...
![文件上传中等难度](E:\cyber safe\笔记\笔记\笔记图片\文件上传中等难度.JPG)
...
![更改上传的htaccess的文件名](E:\cyber safe\笔记\笔记\笔记图片\更改上传的htaccess的文件名.jpg)
...
![文件上传制作图片码](E:\cyber safe\笔记\笔记\笔记图片\文件上传制作图片码.jpg)
...
![文件包含和文件上传完成shell](E:\cyber safe\笔记\笔记\笔记图片\文件包含和文件上传完成shell.jpg)
...
![sql注入判断回显列](E:\cyber safe\笔记\笔记\笔记图片\sql注入判断回显列.jpg)
...
![联合查询数据库表名](E:\cyber safe\笔记\笔记\笔记图片\联合查询数据库表名.jpg)
...
![sql注入爆出用户名密码](E:\cyber safe\笔记\笔记\笔记图片\sql注入爆出用户名密码.jpg)
...
![sql盲注构造payload](E:\cyber safe\笔记\笔记\笔记图片\sql盲注构造payload.jpg)

### ![sql盲注选择爆破数值](E:\cyber safe\笔记\笔记\笔记图片\sql盲注选择爆破数值.jpg)
...
![安装co2插件](E:\cyber safe\笔记\笔记\笔记图片\安装co2插件.jpg)
...
![](E:\cyber safe\笔记\笔记\笔记图片\xml漏洞点.jpg)

```
可以很清楚看到content-type是xml，输入的数据是标签的形式显示的
```

![](E:\cyber safe\笔记\笔记\笔记图片\构造xxe漏洞.jpg)
...
![](E:\cyber safe\笔记\笔记\笔记图片\实战项目一注入点.jpg)
...
![](E:\cyber safe\笔记\笔记\笔记图片\项目1御剑目录扫描.jpg)
...
![java的JNDI构造恶意代码](E:\cyber safe\笔记\笔记\笔记图片\java的JNDI构造恶意代码.jpg)
